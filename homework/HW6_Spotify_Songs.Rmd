...
```{r}
spotify_songs |> summarize(mean = mean(danceability), standard_dev = sd(danceability))
...
This is mostly a normal distribution. The data is slightly skewed to the left, but there are not major spikes and dips. A higher mean tells us that there are more songs with higher danceability than lower danceability. They are bringing the mean up. Additionally, this data distrubition makes sense for spotify. I assume that more songs would be danceable than not.  
