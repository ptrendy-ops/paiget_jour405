...
The distribution is normal for the most part. It is somewhat skewed to the left, but is generally increasing/decreasing continuously (the data doesn't dip and then increase). More car thefts fall within +2 standard deviation points of the mean, than fall within -2 standard deviation points of the mean. From a quick glance around 2/3 of the data falls within these +/-2 ranges. Additionally, this data is somewhat normal for data related to car thefts. There might be fewer car thefts on a certain day in January when conditions are snowy, icy, or rainy and therefore unsafe to drive. 
